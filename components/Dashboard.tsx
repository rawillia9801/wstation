...
export default function Dashboard() {
  ...
  return (
    <main className='min-h-screen telemetry-grid relative overflow-hidden px-6 py-4'>
      <div className='scanline absolute inset-0 pointer-events-none' />
      <section className='relative z-10 w-full space-y-4'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 items-start'>
          <div>
            <div className='text-cyan-400 tracking-[0.3em] text-xs mb-1'>LIVE PERSONAL WEATHER STATION</div>
            <h1 className='text-5xl lg:text-7xl xl:text-8xl font-black leading-[0.9]'>Staley Street Weather</h1>
            <p className='text-slate-300 mt-2 text-lg'>Marion, Virginia • Station KVAMARIO42 • <span className='text-green-400'>LIVE</span></p>
          </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-4'>
          <div className='lg:col-span-7'><HeroConditionPanel condition='Rain' temperature={station?.imperial?.temp ?? '--'} /></div>
