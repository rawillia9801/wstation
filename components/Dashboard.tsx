      ...
      <section className="h-full w-full flex flex-col gap-3">
        <div className="h-[10%] grid grid-cols-2 gap-3">
          <div className="flex flex-col justify-center">
            <div className="text-cyan-400 tracking-[0.28em] text-[10px] mb-1">LIVE PERSONAL WEATHER STATION</div>
            <h1 className="text-4xl xl:text-6xl font-black leading-none">Staley Street Weather</h1>
        ...
        <div className="h-[30%] grid grid-cols-12 gap-3">
          ...
          <div className="col-span-6 h-full grid grid-cols-4 gap-3">
        ...
        <div className="h-[28%] grid grid-cols-12 gap-3">
        ...
        <div className="h-[22%] grid grid-cols-12 gap-3">
