...
export default function Dashboard() {
  ...
  return (
    <main className="h-[100dvh] w-[100dvw] overflow-hidden bg-gradient-to-b from-slate-900 to-black px-3 md:px-4 xl:px-5 py-3 flex flex-col">
      ...
      <div className="flex items-start justify-between gap-4 min-h-0">
        <div className="min-w-0 flex-1 max-w-[58%]">
          ...
          <h1 className="font-black leading-[0.9] text-[30px] md:text-[46px] xl:text-[64px] 2xl:text-[74px] break-words">Staley Street Weather</h1>
      ...
      <div className="grid grid-cols-12 gap-3 xl:gap-4 mt-3 min-h-0">
        <div className="col-span-6 h-[20dvh] md:h-[22dvh] xl:h-[24dvh] min-w-0 min-h-0"><HeroConditionPanel condition="Rain" temperature={station?.imperial?.temp ?? '--'} /></div>
        <div className="col-span-6 grid grid-cols-4 gap-3 xl:gap-4 h-[20dvh] md:h-[22dvh] xl:h-[24dvh] min-w-0 min-h-0">
      ...
      <div className="grid grid-cols-12 gap-3 xl:gap-4 mt-3 min-h-0">
        <div className="col-span-9 h-[17dvh] md:h-[19dvh] xl:h-[21dvh] min-w-0 min-h-0"><ForecastStrip periods={forecast} /></div>
        <div className="col-span-3 h-[17dvh] md:h-[19dvh] xl:h-[21dvh] min-w-0 min-h-0"><MoonPhasePanel moonPhase="Waning Gibbous" illumination="76%" /></div>
      </div>

      <div className="mt-3 rounded-xl border border-fuchsia-400/20 bg-slate-950/70 overflow-hidden py-2 whitespace-nowrap flex-shrink-0">
      ...
      <div className="mt-auto h-[22px] md:h-[24px] xl:h-[28px] flex items-center justify-between text-[9px] md:text-[11px] xl:text-[13px] text-cyan-300 px-2 border-t border-cyan-400/20 flex-shrink-0">
